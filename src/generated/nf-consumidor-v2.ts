/**
 * ⚠️  AUTO-GENERATED from nf-consumidor-v2.yaml
 *
 * Do not edit this file directly.
 *
 * To regenerate: npm run generate
 * Last generated: 2026-04-25T23:15:33.874Z
...
export interface paths {
    readonly "/v2/companies": {
         ...
         */
        readonly get: operations["V2CompaniesGet"];
        readonly put?: never;
        /**
         * Criar uma Empresa
         * @description ### Informações adicionais
         ...
         */
        readonly post: operations["V2CompaniesPost"];
    ...
    readonly "/v2/companies/{company_id}": {
         ...
         */
        readonly get: operations["V2CompaniesByCompany_idGet"];
        /**
         ...
         */
        readonly put: operations["V2CompaniesByCompany_idPut"];
        readonly post?: never;
        /**
         ...
         */
        readonly delete: operations["V2CompaniesByCompany_idDelete"];
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
        readonly trace?: never;
    ...
    readonly "/v2/companies/{company_id}/certificates": {
         ...
         */
        readonly get: operations["V2CompaniesByCompany_idCertificatesGet"];
        readonly put?: never;
        /**
         ...
         */
        readonly post: operations["V2CompaniesByCompany_idCertificatesPost"];
        readonly delete?: never;
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
    ...
    readonly "/v2/companies/{company_id}/certificates/{certificate_thumbprint}": {
         ...
         */
        readonly get: operations["V2CompaniesByCompany_idCertificatesByCertificate_thumbprintGet"];
        readonly put?: never;
        readonly post?: never;
        /**
         ...
         */
        readonly delete: operations["V2CompaniesByCompany_idCertificatesByCertificate_thumbprintDelete"];
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
        readonly trace?: never;
    ...
    readonly "/v2/companies/{company_id}/statetaxes": {
         ...
         */
        readonly get: operations["V2CompaniesByCompany_idStatetaxesGet"];
        readonly put?: never;
        /**
         ...
         *     **Inscrição Estadual** representa os dados necessários sobre o cadastro Estadual (ICMS) que é preciso para processar Documentos Fiscais na SEFAZ.
         */
        readonly post: operations["V2CompaniesByCompany_idStatetaxesPost"];
        readonly delete?: never;
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
    ...
    readonly "/v2/companies/{company_id}/statetaxes/{state_tax_id}": {
         ...
         *     **Inscrição Estadual** representa os dados necessários sobre o cadastro Estadual (ICMS) que é preciso para processar Documentos Fiscais na SEFAZ.
         */
        readonly get: operations["V2CompaniesByCompany_idStatetaxesByState_tax_idGet"];
        /**
         ...
         *     **Inscrição Estadual** representa os dados necessários sobre o cadastro Estadual (ICMS) que é preciso para processar Documentos Fiscais na SEFAZ.
         */
        readonly put: operations["V2CompaniesByCompany_idStatetaxesByState_tax_idPut"];
        readonly post?: never;
        /**
         ...
         *     **Inscrição Estadual** representa os dados necessários sobre o cadastro Estadual (ICMS) que é preciso para processar Documentos Fiscais na SEFAZ.
         */
        readonly delete: operations["V2CompaniesByCompany_idStatetaxesByState_tax_idDelete"];
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
        readonly trace?: never;
    };
    readonly "/v2/companies/{companyId}/consumerinvoices": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        /**
         * Listar as Notas Fiscais Eletrônicas (NFCE)
         * @description ### Informações adicionais
         *     Utilize esta requisição para consultar uma lista de notas fiscais de consumidor eletrônica por empresa.
         */
        readonly get: {
            readonly parameters: {
                readonly query?: {
            ...
            readonly responses: {
                ...
                readonly 200: {
                    ...
                    content: {
                        readonly "application/json": components["schemas"]["ConsumerInvoicesResource"];
                    };
                };
        ...
        readonly put?: never;
        /**
         * Emitir uma Nota Fiscal de Consumidor Eletrônica (NFCE)
         * @description ### Informações adicionais
        ...
        readonly post: {
            ...
            readonly requestBody?: {
                readonly content: {
                    readonly "application/json": components["schemas"]["ConsumerInvoiceRequest"];
                    readonly "text/json": components["schemas"]["ConsumerInvoiceRequest"];
                    readonly "application/*+json": components["schemas"]["ConsumerInvoiceRequest"];
                };
            };
            readonly responses: {
    ...
    readonly "/v2/companies/{companyId}/consumerinvoices/{invoiceId}": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        /**
         * Consultar por ID uma Nota Fiscal de Consumidor Eletrônica (NFCE)
         * @description ### Informações adicionais
         *     Utilize esta requisição para consultar os dados de uma Nota Fiscal de Consumidor Eletrônica (NFCE) pelo ID.
         */
        readonly get: {
            readonly parameters: {
                readonly query?: never;
        ...
        readonly post?: never;
        /**
         * Cancelar uma Nota Fiscal de Consumidor Eletrônica (NFCE)
         * @description ### Informações adicionais
    ...
    readonly "/v2/companies/{companyId}/consumerinvoices/{invoiceId}/items": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        /**
         * Consultar os produtos por ID uma Nota Fiscal de Consumidor Eletrônica (NFCE)
         * @description ### Informações adicionais
         *     Utilize esta requisição para consultar os dados de uma Nota Fiscal de Consumidor Eletrônica (NFCE) pelo ID.
         */
        readonly get: {
    ...
    readonly "/v2/companies/{companyId}/consumerinvoices/{invoiceId}/events": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        /**
         * Consultar eventos por ID uma Nota Fiscal de Consumidor Eletrônica (NFCE)
         * @description ### Informações adicionais
         *     Utilize esta requisição para consultar os dados de uma Nota Fiscal de Consumidor Eletrônica (NFCE) pelo ID.
         */
        readonly get: {
    ...
    readonly "/v2/companies/{companyId}/consumerinvoices/{invoiceId}/pdf": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        /**
         * Consultar PDF do Documento Auxiliar da Nota Fiscal de Consumidor Eletrônica (DANFE-NFC-e)
         * @description ### Informações adicionais
    ...
    readonly "/v2/companies/{companyId}/consumerinvoices/{invoiceId}/xml": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        /**
         * Consultar XML da Nota Fiscal de Consumidor Eletrônica (NFCE)
         * @description ### Informações adicionais
         *     Utilize esta requisição para consultar os dados de uma nota fiscal de Consumidor Eletrônica pelo ID.
         */
        readonly get: {
            readonly parameters: {
                readonly query?: never;
    ...
    readonly "/v2/companies/{companyId}/consumerinvoices/{invoiceId}/xml/rejection": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        /**
         * Consultar XML de rejeição da Nota Fiscal de Consumidor Eletrônica (NFCE)
         * @description ### Informações adicionais
         *     Utilize esta requisição para consultar o motivo da rejeição de uma nota fiscal de Consumidor Eletrônica pelo ID.
         */
        readonly get: {
            readonly parameters: {
                readonly query?: never;
    ...
    readonly "/v2/companies/{companyId}/consumerinvoices/disablement": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
    ...
    readonly "/v2/webhooks/eventTypes": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
         ...
         */
        readonly get: operations["V2WebhooksEventTypesGet"];
        readonly put?: never;
        readonly post?: never;
        readonly delete?: never;
        readonly options?: never;
    ...
    readonly "/v2/webhooks": {
         ...
         */
        readonly get: operations["V2WebhooksGet"];
        readonly put?: never;
        /**
         * Criar um Webhook
         * @description ### Informações adicionais
         ...
         *     Ou seja, a __Conta da *Empresa A*__ não verá os WebHooks disparados por uma ação executada pelo usuário __Conta da *Empresa B*__.
         */
        readonly post: operations["V2WebhooksPost"];
        /**
         ...
         */
        readonly delete: operations["V2WebhooksDelete"];
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
        readonly trace?: never;
    };
    readonly "/v2/webhooks/{webhook_id}": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
         ...
         */
        readonly get: operations["V2WebhooksByWebhook_idGet"];
        /**
         ...
         */
        readonly put: operations["V2WebhooksByWebhook_idPut"];
        readonly post?: never;
        /**
         ...
         */
        readonly delete: operations["V2WebhooksByWebhook_idDelete"];
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
        readonly trace?: never;
    };
    readonly "/v2/webhooks/{webhook_id}/pings": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
         ...
         */
        readonly put: operations["V2WebhooksByWebhook_idPingsPut"];
        readonly post?: never;
        readonly delete?: never;
        readonly options?: never;
        readonly head?: never;
...
export interface components {
    schemas: {
        ...
        readonly ConsumerInvoiceRequest: {
        ...
        readonly ConsumerInvoicesResource: {
            /** @description Lista de Notas Fiscais de Consumidor Eletrônicas (NFC-e) */
            readonly consumerInvoices?: readonly components["schemas"]["InvoiceWithoutEventsResource"][] | null;
        ...
        /** @enum {string} */
        readonly PaymentMethod: "Cash" | "Cheque" | "CreditCard" | "DebitCard" | "StoreCredict" | "FoodVouchers" | "MealVouchers" | "GiftVouchers" | "FuelVouchers" | "BankBill" | "BankDeposit" | "InstantPayment" | "WireTransfer" | "Cashback" | "StaticInstantPayment" | "StoreCredit" | "ElectronicPaymentNotInformed" | "WithoutPayment" | "Others";
...
export interface operations {
    ...
    readonly V2CompaniesByCompany_idGet: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2CompaniesByCompany_idPut: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2CompaniesByCompany_idDelete: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2CompaniesByCompany_idCertificatesGet: {
        readonly parameters: {
            readonly query?: {
    ...
    readonly V2CompaniesByCompany_idCertificatesPost: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2CompaniesByCompany_idCertificatesByCertificate_thumbprintGet: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2CompaniesByCompany_idCertificatesByCertificate_thumbprintDelete: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2CompaniesByCompany_idStatetaxesGet: {
        readonly parameters: {
            readonly query?: {
                /** @description Id de início do contador (Default: Empty) */
                readonly startingAfter?: string;
    ...
    readonly V2CompaniesByCompany_idStatetaxesPost: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2CompaniesByCompany_idStatetaxesByState_tax_idGet: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2CompaniesByCompany_idStatetaxesByState_tax_idPut: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2CompaniesByCompany_idStatetaxesByState_tax_idDelete: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2WebhooksEventTypesGet: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
                ...
                content: {
                    readonly "application/json": {
                        ...
                        readonly webHooks?: readonly {
                            ...
                            /**
                             * @description Tipo de mídia usado para serializar as notificações dos eventos que serão entregues.
                             *     Os valores suportados são **json** e **form-urlencoded**, o padrão é **json**.
                             * @enum {string}
                             */
                            readonly contentType?: "json" | "form-urlencoded";
                            /**
                            ...
                            /**
                             * @description Determina se as notificações são enviadas quando o webhook é acionado.
    ...
    readonly V2WebhooksByWebhook_idGet: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2WebhooksByWebhook_idPut: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2WebhooksByWebhook_idDelete: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
    ...
    readonly V2WebhooksByWebhook_idPingsPut: {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path: {
